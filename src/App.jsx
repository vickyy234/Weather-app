...
function App() {
  ...
  return (
    <div className="container-fluid min-vh-100 vw-100 d-flex flex-column justify-content-center align-items-center bg-light pt-3">
      ...
      <div className="row">
        <div className="col-8"><input type="text" className="col-9 form-control hover-card" value={city} onChange={handleChange} placeholder="Enter city..." onKeyDown={handleKeyDown} /></div>
        <div className="col-4"><button className="col-3 btn btn-primary w-100 hover-card" onClick={handleSearch}>Search</button></div>
      </div>
      {response && <div className="card p-3 m-3 shadow-lg align-items-center gap-2 text-center" style={{ width: "fit-content" }}>
        ...
        <div className="d-flex flex-row  flex-wrap gap-3 justify-content-center" style={{ maxWidth: "460px" }}>
          <div className="card p-3 d-flex align-items-center hover-card">
